# Pre-Mortem Algorithm Reference

Full computation spec for `leadv2-premortem.sh` — read this when implementing, tuning,
or debugging the probability table. The main skill only needs the exit codes and
wire-in call points; this file is the "how it computes" detail.
